...
function interpolate_letter(percent, oldObj, newObj) {
  ...
  new_letter["r1x"] = map(percent, 0, 50, oldObj["r1x"], newObj["r1x"]);
  new_letter["r1y"] = map(percent, 0, 50, oldObj["r1y"], targetcricleY);
  new_letter["r2x"] = map(percent, 0, 50, oldObj["r2x"], newObj["r2x"]);
  new_letter["r2y"] = map(percent, 0, 50, oldObj["r2y"], targetcricleY);
  new_letter["r3x"] = map(percent, 0, 50, oldObj["r3x"], newObj["r3x"]);
  new_letter["r3y"] = map(percent, 0, 50, oldObj["r3y"], targetcricleY);
  ...
  new_letter["y1x"] = map(percent, 0, 50, oldObj["y1x"], newObj["y1x"]);
  new_letter["y1y"] = map(percent, 0, 50, oldObj["y1y"], targetcricleY);
  new_letter["y2x"] = map(percent, 0, 50, oldObj["y2x"], newObj["y2x"]);
  new_letter["y2y"] = map(percent, 0, 50, oldObj["y2y"], targetcricleY);
  new_letter["y3x"] = map(percent, 0, 50, oldObj["y3x"], newObj["y3x"]);
  new_letter["y3y"] = map(percent, 0, 50, oldObj["y3y"], targetcricleY);
  ...
  new_letter["rl1x"] = map(percent, 0, 50, oldObj["rl1x"], newObj["rl1x"]);
  new_letter["rl1y"] = map(percent, 0, 50, oldObj["r1y"], newObj["rl1y"]);
  new_letter["rl2x"] = map(percent, 0, 50, oldObj["rl2x"], newObj["rl2x"]);
  new_letter["rl2y"] = map(percent, 0, 50, oldObj["rl2y"], newObj["rl2y"]);
  ...
  new_letter["yl1x"] = map(percent, 0, 50, oldObj["yl1x"], newObj["yl1x"]);
  new_letter["yl1y"] = map(percent, 0, 50, oldObj["yl1y"], newObj["yl1y"]);
  new_letter["yl2x"] = map(percent, 0, 50, oldObj["yl2x"], newObj["yl2x"]);
  new_letter["yl2y"] = map(percent, 0, 50, oldObj["yl2y"], newObj["yl2y"]);
  }
  else{
  ...
  new_letter["r1x"] = map(percent, 51, 100, oldObj["r1x"], newObj["r1x"]);
  new_letter["r1y"] = map(percent, 51, 100, targetcricleY, newObj["r1y"]);
  new_letter["r2x"] = map(percent, 51, 100, oldObj["r2x"], newObj["r2x"]);
  new_letter["r2y"] = map(percent, 51, 100, targetcricleY, newObj["r2y"]);
  new_letter["r3x"] = map(percent, 51, 100, oldObj["r3x"], newObj["r3x"]);
  new_letter["r3y"] = map(percent, 51, 100, targetcricleY, newObj["r3y"]);
  ...
  new_letter["y1x"] = map(percent, 51, 100, oldObj["y1x"], newObj["y1x"]);
  new_letter["y1y"] = map(percent, 51, 100, targetcricleY, newObj["y1y"]);
  new_letter["y2x"] = map(percent, 51, 100, oldObj["y2x"], newObj["y2x"]);
  new_letter["y2y"] = map(percent, 51, 100, targetcricleY, newObj["y2y"]);
  new_letter["y3x"] = map(percent, 51, 100, oldObj["y3x"], newObj["y3x"]);
  new_letter["y3y"] = map(percent, 51, 100, targetcricleY, newObj["y3y"]);
  ...
  new_letter["rl1x"] = map(percent, 51, 100, oldObj["rl1x"], newObj["rl1x"]);
  new_letter["rl1y"] = map(percent, 51, 100, oldObj["r1y"], newObj["rl1y"]);
  new_letter["rl2x"] = map(percent, 51, 100, oldObj["rl2x"], newObj["rl2x"]);
  new_letter["rl2y"] = map(percent, 51, 100, oldObj["rl2y"], newObj["rl2y"]);
  ...
  new_letter["yl1x"] = map(percent, 51, 100, oldObj["yl1x"], newObj["yl1x"]);
  new_letter["yl1y"] = map(percent, 51, 100, oldObj["yl1y"], newObj["yl1y"]);
  new_letter["yl2x"] = map(percent, 51, 100, oldObj["yl2x"], newObj["yl2x"]);
  new_letter["yl2y"] = map(percent, 51, 100, oldObj["yl2y"], newObj["yl2y"]);
}

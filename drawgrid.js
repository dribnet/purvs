...
// temporary variables used for object placement
  let cx=0, cx2=0, cx3=0, cx_line = 0, cx_line_2 =0;
  let  cy=0, cy2 = 0, cy3 = 0;
  ...
  cy = p5.map(0, y1, y2, 0, 256);
  cy2 = p5.map(50, y1, y2, 0, 256);
  cy3 = p5.map(100, y1, y2, 0, 256);

  //1st line
  cx_line= p5.map(0, x1, x2, 0, 256);
  cx_line_2 = p5.map(0, x1, x2, 0, 256);
  p5.line(cx_line,cy,cx_line_2,cy2);
  //2nd line
  p5.line(cx_line,cy2,cx_line_2,cy3);

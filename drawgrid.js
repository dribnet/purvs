...
//  p5.rect(pixel_posx1+pixel_size, pixel_y, pixel_size, pixel_size); 
//  p5.rect(pixel_posx1, pixel_y, pixel_size, pixel_size);    
//  p5.rect(pixel_posx1-pixel_size, pixel_y, pixel_size, pixel_size);
//  p5.rect(pixel_posx1-pixel_size*2, pixel_y, pixel_size, pixel_size);
//  p5.rect(pixel_posx1-pixel_size*3, pixel_y, pixel_size, pixel_size);
    
//  p5.ellipse(pixel_posx1+pixel_size, pixel_y, pixel_size, pixel_size); 
//  p5.ellipse(pixel_posx1, pixel_y, pixel_size, pixel_size);    
//  p5.ellipse(pixel_posx1-pixel_size, pixel_y, pixel_size, pixel_size);
//  p5.ellipse(pixel_posx1-pixel_size*2, pixel_y, pixel_size, pixel_size);
//  p5.ellipse(pixel_posx1-pixel_size*3, pixel_y, pixel_size, pixel_size);
...
//    /*
    //draw rectangles
//if(zoom >= 5){
//    rectangles(true,rect_detail/2,rect_detail/2,true,cur_line_width3);
//    rectangles(true,rect_detail*2,rect_detail*2,true,cur_line_width3);
//}
       if(zoom >= 3){
        ...
        p5.stroke(30,75*brightness);
          ...
          p5.stroke(15,20*brightness);
           p5.fill(120,2*brightness);
            ...
            // p5.ellipse(x_pos, y_pos, cur_rectWidth1*rectSize, cur_rectWidth*rectSize);
        }
...
//      p5.stroke(0, 255, 0)
//           p5.stroke(100,100);
//      for(var x=min_x0; x<max_x0; x+=0.025*grid_size) {
//        for(var y=min_y0; y<max_y0; y+=0.025*grid_size) {
//          drawRectangles(p5, x1, x2, y1, y2, x, y, 0.005*rectWidth, 0.0005*rectWidth);
//          drawRectangles(p5, x1, x2, y1, y2, x, y, 0.005*rectWidth, 0.0005*rectWidth);
//        }
//      }
//   }
  if(zoom >= 5) {
      ...
      var noiseValue = p5.noise(x,y);
       // p5.fill(noiseValue*120,noiseValue*200);
        p5.stroke(noiseValue*150,noiseValue*100);
          //drawRectangles(p5, x1, x2, y1, y2, x, y, 0.05*rectWidth, 0.005*rectWidth);
             //drawRectangles(p5, x1, x2, y1, y2, x, y, 0.05*rectWidth, 0.005*rectWidth);
             //drawRectangles(p5, x1, x2, y1, y2, x, y, 0.05*rectWidth, 0.005*rectWidth);

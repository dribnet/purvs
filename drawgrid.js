...
function showCheck(p5, n, y, noiseScale) {
  var showLeaf = p5.noise(n * noiseScale,
                        y * noiseScale);
 
  return (Math.floor(5*showLeaf))
}
...
function drawGrid(p5, x1, x2, y1, y2, z, zoom) {
  ...
  var c_p00 = p5.map(0, x1, x2, 0, 400);
  var c_pball = p5.map(ball_radius, x1, x2, 0, 400);

...
function myPattern(p5, x, y, x1, x2, y1, y2)  {
  ...
  p5.beginShape(); //long zigzag
    ...
    p5.vertex(zzz_x1, zzz_y1);
    p5.vertex(zzz_x2, zzz_y);
    p5.vertex(zzz_x3, zzz_y1);
    p5.vertex(zzz_x4, zzz_y);
    p5.vertex(zzz_x5, zzz_y1);
  p5.endShape();
  ...
  p5.line(line_x, line_y, line_x1, line_y1);
  ...
  p5.beginShape(); //top V
    ...
    p5.vertex(topV_x1, topV_y1);
    p5.vertex(topV_x2, topV_y2);
  p5.endShape();

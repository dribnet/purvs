...
// }
   ...
   if(alarmsec > 0){
   rect(c+50, v, 100, 40);
   rect(c+200, v-80, 70, 30);
   rect(c+100, v-20, 200, 50);
   rect(c+10, v+30, 80, 30);
   rect(c+300, v+100, 80, 30);
   rect(c+370, v+230, 80, 30);
   rect(c+230, v+170, 80, 30);
   rect(c+160, v-60, 80, 30);
   rect(c+50, v+190, 80, 30);
   rect(c+670, v+70, 80, 30);
   rect(c+500, v+130, 80, 30);
   rect(c+570, v+180, 80, 30);
   c = c + random(-7, 0.5);
       if(c < -900) {
           c = 950;
   }
    ...
    //vert
//    if(alarmsec > 0){
//    rect(c+400, v-40, 100, 50);
//    rect(c+490, v+100, 50, 120);
//    rect(c+300, v+50, 30, 110);
//    rect(c+500, v, 60, 100);
//    rect(c+600, v-40, 50, 100);
//    rect(c, v-20, 70, 200);
//    rect(c+150, v-50, 40, 130);
//    rect(c+200, v-100, 40, 80);
//    rect(c+300, v-90, 40, 130);
//    rect(c+400, v-50, 40, 130);
//    rect(c+200, v-60, 45, 85);
//    v = v + random(-1,10);
//        
//    if (v < 0){
//        v = 0;

...
function FaceMap() {
	...
	this.draw = function(positions) {
		...
		var staticElectricityStroke = [this.hue,100,20];
		
		if(this.includesDome > 50){
			leftAntennaIndex = 2;
			rightAntennaIndex = 2;
		...
		var openLevel = map(this.mouthOpenLevel, 0, 100, 1, 0);  
	...
	*/
	...
	this.getProperties = function() {
		...
		properties[3] = this.includesDome;
		return properties;
	}
}

...
function FaceMap() {
   ...
   */
   this.draw = function(positions) {
    ...
    drawMonster(positions,x,y,w,h,face,noseType,mouthType,mouth_pos,scheme);
  ...
  function drawMonster(positions,x,y,w,h,face,noseType,mouthType,mouth_pos,scheme){

...
function FaceMap() {
	...
	this.draw = function (positions) {
		...
		fill(bg_color);
		ellipse(eye1_pos[0], eye1_pos[1], (maxHeightL - minHeightL) * 3 * scale, (maxHeightL - minHeightL) * 3 * scale);
		ellipse(eye2_pos[0], eye2_pos[1], (maxHeightR - minHeightR) * 3 * scale, (maxHeightR - minHeightR) * 3 * scale);

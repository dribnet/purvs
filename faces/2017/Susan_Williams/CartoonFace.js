...
//slider 3 for different face shape and eyes 
// slider4 for different mouth //mouth tilt slider 2
//slider 5 nose // nose size slider 2
...
//a cartoon face, capable of modifying and drawing itself 
function CartoonFace(w, h, sliders){
	//the dimensions of the graphics object to be drawn
	this.w = w;
	this.h = h;
	//the random number sliders object 
...
this.drawFace = function(){
	...
	//draws the face
	this.drawWithWeight();
	//returns the finished drawing
	this.c.pop();
	return this.c;
}

this.drawWithWeight = function(){
	//chooses the weighting scheme based on random number 1 in the slider object
	//calls a function which then does the drawing at the specified weights
...
//translates the canvas based on random Number 2
//draws one of the mouths based on the integer mNum
this.mouth = function(){
	//gets a number to decide which mouth
...
//draws an open mouth at position 0,0

...
function drawCalvin(){
	...
	calvin.pop();
	image(calvin, canvasWidth/2, canvasHeight);
 	image(calvin,0,0,canvasWidth/2, canvasHeight);
...
drawMissyHead()
 ...
 drawMissyFace()
	...
	image(missy, canvasWidth/2, canvasHeight);
image(missy,canvasWidth/2,0,canvasWidth/2, canvasHeight);
}

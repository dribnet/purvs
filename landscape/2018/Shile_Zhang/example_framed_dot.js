...
//flower mid
   var fx = p5.map(600, x1, x2, 0, 256);
   var fy = p5.map(350, y1, y2, 0, 256);
   var fx2 = p5.map(600*2, x1, x2, 0, 256);
   var fy2 = p5.map((350+120)*2, y1, y2, 0, 256);

   p5.fill(clockOuter);
   p5.ellipse(fx, fy, fx2 - fx, fy2 - fy);

   //flower out1
   var fx = p5.map(600, x1, x2, 0, 256);
   var fy = p5.map(350, y1, y2, 0, 256);
   var fx2 = p5.map(600+80, x1, x2, 0, 256);
   var fy2 = p5.map(350+150, y1, y2, 0, 256);

   p5.fill(clockInner);  
   p5.ellipse(fx, fy+80, fx2*1.2 - fx*1.2, fy2*1.4 - fy*1.4);
   p5.ellipse(fx, fy-80, fx2*1.2 - fx*1.2, fy2*1.4 - fy*1.4);
         p5.fill(120);  
   p5.ellipse(fx, fy+80, fx2 - fx, fy2 - fy);
   p5.ellipse(fx, fy-80, fx2 - fx, fy2 - fy);


   var fy1 = p5.map(600, y1,y2, 0, 256);
   var fx1 = p5.map(350, x1, x2, 0, 256);
   var fy3 = p5.map(600-80, y1,y2, 0, 256);
   var fx3 = p5.map(350-150, x1, x2, 0, 256);

   p5.fill(255);  
   p5.ellipse(fx1+150, fy1-250,fx3*1.4 - fx1*1.4, fy3*1.2 - fy1*1.2);
   p5.ellipse(fx1+350, fy1-250, fx3*1.4 - fx1*1.4, fy3*1.2 - fy1*1.2);
  p5.fill(120);  
   p5.ellipse(fx1+150, fy1-250, fx3 - fx1, fy3 - fy1);
   p5.ellipse(fx1+350, fy1-250, fx3 - fx1, fy3 - fy1);

   //flower mid
   var fx3 = p5.map(600, x1, x2, 0, 256);
   var fy3 = p5.map(350, y1, y2, 0, 256);
   var fx4 = p5.map(600-80, x1, x2, 0, 256);
   var fy4 = p5.map(350-80, y1, y2, 0, 256);

   p5.fill(clockOuter);
   p5.ellipse(fx3, fy3, fx4 - fx3, fy4 - fy3);

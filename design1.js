...
function drawRain(p5, x1, x2, y1, y2, pos_x, pos_y, rad1, rad2) {
...
//     let offset = offsets[i];
//     let pixel_x = p5.map(pos_x+0.5*rad1*offset[0], x1, x2, 0, 0);
//     let pixel_y = p5.map(pos_y+0.5*rad1*offset[1], y1, y2, 0, 512);
//     p5.strokeWeight(0);
//     p5.ellipse(pixel_x, pixel_y, pixel_radius);
//     if(drawLines) {
